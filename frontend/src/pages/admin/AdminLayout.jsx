...
import { LayoutDashboard, Home, Users, Calendar, MessageSquare, FileText, Map, Star, Settings, Bell, Menu } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      <aside className="hidden lg:flex flex-col w-64 bg-navy-500 shrink-0">
        <DashboardSidebar menu={MENU} basePath="/admin" portalTag="ADMIN PANEL" user={user} subtitle={user?.role} onLogout={handleLogout} onNavigate={() => setSideOpen(false)} />
      </aside>
